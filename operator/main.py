...
class TnpaControlUI(QWidget):
    def __init__(self):
        ...
        self.servo_buttons["Servo1+"].clicked.connect(lambda: self.control_thread.receive_data.emit({'s1': '120'}))
        self.servo_buttons["Servo1-"].clicked.connect(lambda: self.control_thread.receive_data.emit({'s1': '60'}))
        self.servo_buttons["Servo2+"].clicked.connect(lambda: self.control_thread.receive_data.emit({'s2': '120'}))
        self.servo_buttons["Servo2-"].clicked.connect(lambda: self.control_thread.receive_data.emit({'s2': '60'}))
        self.servo_buttons["Servo3+"].clicked.connect(lambda: self.control_thread.receive_data.emit({'s3': '120'}))
        self.servo_buttons["Servo3-"].clicked.connect(lambda: self.control_thread.receive_data.emit({'s3': '60'}))
        self.servo_buttons["Servo4+"].clicked.connect(lambda: self.control_thread.receive_data.emit({'s4': '120'}))
        self.servo_buttons["Servo4-"].clicked.connect(lambda: self.control_thread.receive_data.emit({'s4': '60'}))
